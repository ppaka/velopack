...
public class VelopackRepository : SourceRepository<VelopackDownloadOptions, VelopackUpdateSource>, IRepositoryCanUpload<VelopackUploadOptions>
{
    ...
    public override VelopackUpdateSource CreateSource(VelopackDownloadOptions options)
    {
        return new VelopackUpdateSource();
    }
